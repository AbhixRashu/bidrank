...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] bg-[#F8F7F3] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-[#101114] mb-2">Welcome back</h1>
        ...
        <p className="text-sm text-gray-500 text-center mt-6">
          ...
          <Link href="/signup" className="font-medium text-[#245BFF] hover:underline">
            Sign up
          </Link>
        </p>
      </div>
